  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(_languageStore.language.incidentUpping),
      ),
      //backgroundColor: CustomColor.primaryColor,
      body: Padding(
  ...
  Widget navigate(BuildContext context) {
    Future.delayed(Duration(milliseconds: 0), () {
      FlushbarHelper.createSuccess(
        message: _languageStore.language.incidentUppedSuccessMessage,
          ...
          return _incidentFormStore.loading == true
              ? Visibility(
                  ...
                  child: CustomProgressIndicatorTextWidget(
                    message: _languageStore.language.incidentUppingInProgressMessage,
                  ),
                )
              : Padding(
                  padding: const EdgeInsets.only(
      ...
      Future.delayed(Duration(milliseconds: 0), () {
        if (message.isNotEmpty) {
          FlushbarHelper.createSuccess(
            message: message,
            title:
                _languageStore.language.successMessageTitle,
