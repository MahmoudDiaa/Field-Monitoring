...
class IncidentSdadScreen extends StatefulWidget {
  IncidentSdadScreen();

  @override
  _IncidentSdadScreenState createState() => _IncidentSdadScreenState();
}

class _IncidentSdadScreenState extends State<IncidentSdadScreen> {
  //stores:---------------------------------------------------------------------
