...
class AssignedIncidentListScreen extends StatefulWidget {
 ...
 final bool hideSubCategoryWidget;
  ...
  @override
  _AssignedIncidentListScreenState createState() => _AssignedIncidentListScreenState();
...
class _AssignedIncidentListScreenState extends State<AssignedIncidentListScreen> {
                              ...
                              onChange: (d) {
                                Navigator.of(context).push(MaterialPageRoute(
                                    builder: (context) => InidentDetailsScreen(
                                          incidentId: d?.id,incidentStore: Provider.of<AssignedIncidentStore>(context),
                                        )));
                              },
                              validator: (Incident? value) {
                                return null;
                              } ,
                            incidentStore: Provider.of<AssignedIncidentStore>(context),),
                          );
                  },
