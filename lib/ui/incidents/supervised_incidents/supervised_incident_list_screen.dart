...
class SupervisedIncidentListScreen extends StatefulWidget {
 ...
 final bool hideSubCategoryWidget;
  ...
  @override
  _SupervisedIncidentListScreenState createState() => _SupervisedIncidentListScreenState();

  SupervisedIncidentListScreen(
      {this.initialSubCategoryId,
      this.showBack=false ,
      this.hideSubCategoryWidget = false});
}

class _SupervisedIncidentListScreenState extends State<SupervisedIncidentListScreen> {
              ...
              children: [
                ...
                Center(
                  child: Padding(
                    ...
                    child: Text(
                      '${_appLocalizations.translate('mySupervisedIncidents')}',
                      style: TextStyle(
                              ...
                              onChange: (d) {
                                Navigator.of(context).push(MaterialPageRoute(
                                    builder: (context) => InidentDetailsScreen(
                                          incidentId: d?.id,incidentStore:  Provider.of<SupervisedIncidentStore>(context)),
                                        ));
                              },
                              validator: (Incident? value) {
                                return null;
                              },
                        incidentStore: Provider.of<SupervisedIncidentStore>(context), ),
                          );
                  },
