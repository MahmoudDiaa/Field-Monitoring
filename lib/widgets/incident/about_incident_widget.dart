...
class AboutIncidentWidget extends StatefulWidget {
  final Incident incident;
  void Function()? onSdadDone;
  void Function()? onFinallySdadDone;
  void Function()? onUppingSdadDone;
  ...
  @override
  _AboutIncidentWidgetState createState() => _AboutIncidentWidgetState();
}

class _AboutIncidentWidgetState extends State<AboutIncidentWidget> {
  @override
        ...
        Row(
          children: widget.incident.districtName != null
              ? [
                  ...
                  Flexible(
                    child: Text(
                        '${widget.incident.districtName}-${widget.incident.address}'),
                  ),
                ]
              : [],
        ),
