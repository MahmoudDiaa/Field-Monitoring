...
part of 'created_incident_store.dart';
...
mixin _$CreatedIncidentStore on _CreatedIncidentStore, Store {
  Computed<bool>? _$loadingComputed;

  @override
  bool get loading => (_$loadingComputed ??= Computed<bool>(() => super.loading,
          name: '_CreatedIncidentStore.loading'))
      .value;
  ...
  bool get loadingMore =>
      (_$loadingMoreComputed ??= Computed<bool>(() => super.loadingMore,
              name: '_CreatedIncidentStore.loadingMore'))
          .value;
  ...
  bool get gettingIncident =>
      (_$gettingIncidentComputed ??= Computed<bool>(() => super.gettingIncident,
              name: '_CreatedIncidentStore.gettingIncident'))
          .value;

  late final _$fetchIncidentsFutureAtom = Atom(
      name: '_CreatedIncidentStore.fetchIncidentsFuture', context: context);
  ...
  late final _$fetchMoreIncidentsFutureAtom = Atom(
      name: '_CreatedIncidentStore.fetchMoreIncidentsFuture', context: context);
  ...
  late final _$fetchIncidentFutureAtom =
      Atom(name: '_CreatedIncidentStore.fetchIncidentFuture', context: context);
  ...
  late final _$incidentListAtom =
      Atom(name: '_CreatedIncidentStore.incidentList', context: context);
  ...
  late final _$incidentAtom =
      Atom(name: '_CreatedIncidentStore.incident', context: context);
  ...
  late final _$successAtom =
      Atom(name: '_CreatedIncidentStore.success', context: context);
  ...
  late final _$getIncidentsAsyncAction =
      AsyncAction('_CreatedIncidentStore.getIncidents', context: context);
  ...
  late final _$getMoreAsyncAction =
      AsyncAction('_CreatedIncidentStore.getMore', context: context);
  ...
  late final _$getIncidentAsyncAction =
      AsyncAction('_CreatedIncidentStore.getIncident', context: context);
